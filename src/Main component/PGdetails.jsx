    ...
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <img
              src="/placeholder-image-small.png"
              alt="Hostel Thumbnail"
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">Trinity Girls Hostel</h1>
          <p className="text-gray-600 mt-2">
            34, Panchsheel Colony, Jaipur, Rajasthan, 302019 • 📞 9828XXXXXX •
            Only Girls
          </p>
          <p className="text-lg font-semibold text-green-600 mt-2">Per month rent starting from ₹5,000</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-yellow-100 p-4 rounded-lg shadow">
          ...
          <p className="text-gray-700 mt-2">Triple Occupancy • ₹15,000/mo*</p>
        </div>
        <div className="bg-red-100 p-4 rounded-lg shadow">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            <span className="bg-red-200 px-3 py-1 rounded">Geyser</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow mt-6">
        ...
        <ul className="list-disc list-inside mt-2 text-gray-700">
          <li>PG 1 - 500 meters</li>
          <li>PG 2 - 700 meters</li>
          <li>PG 3 - 1 km</li>
        </ul>
      </div>
    </div>
