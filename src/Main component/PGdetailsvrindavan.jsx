...
export default function PGVrindavan () {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">PGVrindavan  & Blessings Pg</h1>
          <p className="text-gray-600 mt-2">
          35B, Sodala, Jaipur, Rajasthan, 302006,9328XXXXXX ,StayEase -Co-Living Per month rent starting from
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-yellow-100 p-4 rounded-lg shadow">
          ...
          <p className="text-gray-700 mt-2">Single Occupancy X4 • ₹5,000/mo*</p>
        </div>
