...
export default function PGDetailsmentro() {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">Mentor 365 Gurukul</h1>
          <p className="text-gray-600 mt-2">
          SH 24, , Jaipur, Haryana, 123101 ,9468XXXXXXbtroomer-Only Boys


          </p>
          <p className="text-lg font-semibold text-green-600 mt-2">Per month rent starting from ₹25,000</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-yellow-100 p-4 rounded-lg shadow">
          ...
          <p className="text-gray-700 mt-2">3+ Occupancy X4 • ₹100,000/mo*</p>
        </div>
