...
export default function PGRaga() {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">Raga</h1>
          <p className="text-gray-600 mt-2">
          Santkrupa Fabrication, Hinjawadi, Pune, Maharashtra, 411057 ,9635XXXXXX,StayEase -Co-Living
