...
export default function PGDetailorovia() {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">Orovia P/1901</h1>
          <p className="text-gray-600 mt-2">
          thane west , Thane, Maharashtra, 400615,7666XXXXXX StayEase -Only Girls
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-yellow-100 p-4 rounded-lg shadow">
          ...
          <p className="text-gray-700 mt-2">3+ Occupancy X4 • ₹20,000/mo*</p>
        </div>
