...
export default function PearlHostel() {
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-semibold text-gray-800">Pearl Hostel</h1>
          <p className="text-gray-600 mt-2">
          SH 24, , Jaipur, Haryana, 123101 ,9468XXXXXXbtroomer-Only Girls
